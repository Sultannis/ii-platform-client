...
import { openNewsModal, setSelectedNewsItemId } from '../NewsModal/composables/selectedNewsItem';

const { title, paragraph, date } = defineProps({
    id: {
        type: Number,
        required: true,
    },
...
<template>
    <div class="newscard" @click="handleCardClick(id)">
